...
async function seedBenchmarks() {
  ...
  const rows = [
    ...
    { metric: 'COP target for this product', value: 'TBD', unit: 'COP', source_title: null, confidence_tag: 'needs_expert', notes: 'Must be competitive with split AC. To be established via engineering analysis.' },
    { metric: 'Retail price of 1-ton split AC (India)', value: '30,000–50,000', unit: 'INR', source_title: null, confidence_tag: 'estimate', notes: 'Market research range. Verify quarterly.' },
    { metric: 'Monthly electricity cost, 1-ton AC at 8hr/day', value: '1,500–2,500', unit: 'INR/month', source_title: null, confidence_tag: 'estimate', notes: 'Assumes BEE 3-star, INR 7/kWh average residential tariff.' },
    { metric: 'Target BOM cost', value: 'TBD', unit: 'INR', source_title: null, confidence_tag: 'needs_expert', notes: 'To be established via unit economics workflow.' },
    { metric: 'India room AC market size', value: '4–6', unit: 'USD billion', source_title: null, confidence_tag: 'estimate', notes: 'Verify via CEAMA/EMAAR reports.' },
  ];
